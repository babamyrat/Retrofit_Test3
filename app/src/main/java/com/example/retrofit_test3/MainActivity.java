package com.example.retrofit_test3;
...
import com.example.retrofit_test3.adapter.MovieListAdapter;
import com.example.retrofit_test3.model.MovieMode;
import com.example.retrofit_test3.viewmodel.MovieListViewModel;

import java.util.List;

public class MainActivity extends AppCompatActivity implements MovieListAdapter.ItemClickListener {

    private List<MovieMode> movieModelList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewModel.getMoviesListObserver().observe(this, new Observer<List<MovieMode>>() {
            @Override
            public void onChanged(List<MovieMode> movieModels) {
                if(movieModels != null) {
    ...
    @Override
    public void onMovieClick(MovieMode movie) {

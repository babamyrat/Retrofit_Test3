package com.example.retrofit_test3.adapter;
...
import com.example.retrofit_test3.R;
...
public class MovieListAdapter  extends RecyclerView.Adapter<MovieListAdapter.MyViewHolder> {
    ...
    private List<MovieMode> movieList;
    private ItemClickListener clickListener;

    public MovieListAdapter(Context context, List<MovieMode> movieList, ItemClickListener clickListener) {
        this.context = context;
        this.movieList = movieList;
        this.clickListener = clickListener;
    }

    public void setMovieList(List<MovieMode> movieList) {
        this.movieList = movieList;
